...
| `enable_web_search` | Register the opt-in `ha_web_search` tool. Kagi or Google credentials and the privacy controls (safe search, domain allow/block lists) are configured in the Web Search section of the web settings UI. | `false` |
