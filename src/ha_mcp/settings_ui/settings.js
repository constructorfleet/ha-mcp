...
const ADVANCED_FIELD_META = {
  ...
  web_search_provider: { label: "Web search provider", help: "Search engine used when generating duplicate-check links in ha_report_issue." },
  web_search_allow_external: { label: "Allow external web-search links", help: "When off, ha_report_issue does not generate external duplicate-check URLs." },
  web_search_include_error_keywords: { label: "Include error keywords in web queries", help: "When off, duplicate-check queries use only generic ha-mcp terms to reduce data disclosure." },
  web_search_safe_search: { label: "Enable safe-search in web queries", help: "Adds each provider's safe-search controls when generating duplicate-check URLs." },
